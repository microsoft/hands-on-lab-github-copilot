...
2 - Ask Copilot to generate the equivalent code in Python with comments. Create a new Python file and paste the code generated by Copilot.
...
3 - Ask Copilot to generate test cases for the Python code using the `/tests` command in the Copilot Chat window.
